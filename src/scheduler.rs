...
pub fn update_schedule(mgr: &mut Mgr, date_time: DateTime<Local>, backup_dir: &str) -> Result<(), SchedulingError> {
    ...
    mgr.schedule.update_scheduling(&tariffs, &production, consumption, soc_in, date_time);
